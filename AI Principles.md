# HealthSync Engineering Principles that would benefit from AI augmentation
# First
...
- Success Metrics: 
  ...
  Average PR size → Increasing, Review time → Increasing, Stale branches → Increasing - PR cadence principle is failing                     
  PR frequency → Increasing, Review time → Decreasing,Stale branches → Decreasing - PR cadence principle is working
